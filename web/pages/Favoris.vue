<template>
    <div class="p-6 bg-gray-100 min-h-screen">
        ...
        <h2 class="text-2xl mb-6">Vos salles favorites :</h2>
        <ul>
            <li v-for="favori in favoris" :key="favori.salle" class="mb-2">
                <NuxtLink :to="`/salle/${favori.salle}`" class="inline-block px-6 py-2 text-lg text-white bg-blue-500 rounded hover:bg-blue-600">
                    {{ favori.salle }}
                </NuxtLink>
            </li>
        </ul>
